...
export default function PortalSetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("success");
      setMessage(data.message ?? "Password set. You can sign in with your email and password.");
    } catch {
      setStatus("error");
    ...
    return (
      <div className="max-w-md mx-auto">
        ...
        <p className="text-slate-600 mb-4">
          This page requires a valid link. Check your email for the &quot;Set your patient portal password&quot; message, or request a new link from your clinic.
        </p>
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <p className="text-slate-600 mb-6">
        Choose a password for your patient portal. You can then sign in with your email and password anytime.
      </p>
