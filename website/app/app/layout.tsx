...
export default async function AppLayout({
    ...
    ? [
        ...
        { href: "/app/email-campaigns", labelKey: "emailCampaigns", iconKey: "emailCampaigns" },
        {
          ...
          children: [
            ...
            { href: "/app/settings/email-templates", labelKey: "emailTemplates", iconKey: "emailCampaigns" },
    ...
    ? [
        {
          ...
          items: [
            ...
            { href: "/app/super/patient-search", labelKey: "superPatientSearch", iconKey: "patients" },
            { href: "/app/super/email-templates", labelKey: "emailTemplates", iconKey: "emailCampaigns" },
            { href: "/app/super/promotion-codes", labelKey: "superPromotionCodes", iconKey: "billing" },
            { href: "/app/super/locale-settings", labelKey: "superLocaleSettings", iconKey: "superDashboard" },
            { href: "/app/super/payment-settings", labelKey: "superPaymentSettings", iconKey: "billing" },
  ...
  const labels: Record<string, string> = {
    ...
    emailTemplates: t("emailTemplates"),
    ...
    superPatientSearch: t("superPatientSearch"),
    superPromotionCodes: t("superPromotionCodes"),
    superLocaleSettings: t("superLocaleSettings"),
    superPaymentSettings: t("superPaymentSettings"),
    settings: t("settings"),
    logOut: t("logOut"),
